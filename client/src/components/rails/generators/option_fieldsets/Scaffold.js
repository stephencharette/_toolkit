...
function Scaffold({
  fieldPairs,
  handleAddOptionPair,
  handleOptionPairTextChange,
  handleOptionPairSelectChange,
  handleNameChange,
  handleOptionsChange,
}) {
  return (
    <fieldset className="flex flex-col text-left space-y-3 mt-2">
      ...
      <TextFieldWithLabel
        name="scaffold-name"
        placeholder="[name]_controller.rb"
        label="Name"
      ...
      <div className="flex flex-col space-y-2">
        ...
        <Toggle
          name={"--force-plural"}
          label={"Forces the use of the plural model name"}
          handleChange={handleOptionsChange}
        />
        <Toggle
          name={"--no-resource-route"}
          label={"Skip resource route generation"}
          handleChange={handleOptionsChange}
        />
        <Toggle
          name={"--api"}
        ...
        <TextFieldWithLabel
          name="--orm="
          placeholder="active_record"
          label="ORM to be invoked"
          id="scaffold-orm-name"
          handleChange={handleOptionsChange}
        />
        <TextFieldWithLabel
          name="--model-name="
          label="ModelName to be used"
          id="scaffold-model-name"
          handleChange={handleOptionsChange}
        />
      </div>
      ...
      <div className="flex flex-col space-y-2">
        ...
        <Toggle
          name={"--no-jbuilder"}
          label={"Generate jbuilder"}
          handleChange={handleOptionsChange}
        />
        <TextFieldWithLabel
          name="--template-engine="
          label="Template engine to be invoked."
          id="scaffold-template-engine"
          handleChange={handleOptionsChange}
        />
      </div>
